...
// 全グループ共有のカウンタ(1要素)
RWStructuredBuffer<uint> faceWriteCounter : register(u2);
// グループごとの開始位置(8192要素)
RWStructuredBuffer<uint> groupOffset : register(u3);
